    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaymentConfirmationCodes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PaymentConfirmationCodes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PaymentConfirmationCodes_Books_BookId",
                        column: x => x.BookId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentConfirmationCodes_BookId",
                table: "PaymentConfirmationCodes",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentConfirmationCodes_UserId",
                table: "PaymentConfirmationCodes",
                column: "UserId");
